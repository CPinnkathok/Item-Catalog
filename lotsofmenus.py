...
menuItem2 = MenuItem(
    name="Peking Duck",
    description=(
        'A famous duck dish from Beijing[1] that has'
...
menuItem3 = MenuItem(
    ...
    description=(
        'Seared rare ahi, avocado, edamame,'
...
menuItem5 = MenuItem(
    ...
    description=(
        'A Chinese noodle soup made of stewed'
...
menuItem1 = MenuItem(
    name="Pho",
    description=(
        'a Vietnamese noodle soup consisting of broth,'
...
menuItem2 = MenuItem(
    ...
    description=(
        'a common Chinese dumpling which generally'
...
menuItem3 = MenuItem(
    ...
    description=(
        ...
        'are the rich garlic flavor, which is less'
        'noticeable in the Chinese version,'
        'the light seasoning of Japanese gyoza with salt and'
        'soy sauce, and the fact that'
...
menuItem1 = MenuItem(
    ...
    description=(
        'Rich, luscious sponge cake soaked in sweet milk'
...
menuItem3 = MenuItem(
    ...
    description=(
        'Milk snow layered with honey boba,'
...
menuItem5 = MenuItem(
    ...
    description=(
        'Vegan goodness. Burrito filled with rice, garbanzo beans'
...
menuItem5 = MenuItem(
    name="Tonkatsu Ramen",
    description=(
        'Noodles in a delicious pork-based'
...
menuItem1 = MenuItem(
    name="Lamb Curry",
    description=(
        'Slow cook that thang in a pool of tomatoes,'
...
menuItem1 = MenuItem(
    ...
    description=(
        'An unsettlingly huge amount of ripe'
...
menuItem3 = MenuItem(
    ...
    description=(
        'Wild morel mushrooms fried in butter,'
...
menuItem4 = MenuItem(
    ...
    description=(
        ...
        'cooked in a cylindrical clay or metal'
...
menuItem1 = MenuItem(
    ...
    description=(
        'Crispy Toast with Sesame Seeds'
...
menuItem1 = MenuItem(
    ...
    description=(
        'Japanese egg custard served hot'
